...
return "Hello from " + " " + person.lastName};
...
shopper.forEach(function(shopper) {
    //console.log(shopper);
    let discount = shopper.amount * discountPercentage;
...
//  write a discount function
    ...
    function discount() {
        //loop through shopper array
        //check if each shopper spent >200
        shopper.forEach(function (shopper));
    }
        //if shopper amount > 200
        //log the amount spent
        //log they receive a 12% discount
        //log the amount after discount

    if (shopper.amount > 200)  {
        console.log(shopper.name + " : " + "amount spent $ " + shopper.amount);
        console.log("You receive a 12% discount!")
        console.log("amount after discount $ " + shopper.amount * .12);
);
}
     /** TODO:
